				...
				<div class="col-md-10 col-sm-9 col-xs-12 text-right xs-center">
					...
					<div class="search-block-top display-inline">
						...
						<div class="toogle-content">
							<form name="form1" action="GoodsServlet?action=search" method="post"
								id="searchbox">
				...
				<div class="col-xs-12 col-sm-6 col-md-7">
					<div class="product-details">
						...
						<div class="box-quantity">
							<form name="form2" action="shoppingCarServlet?action=detailadd&&goodsid=${it.id }" method="post">
								<label>数量</label>	
					...
					<div class="col-md-12">
						<div class="product-wrapper mb-40 mrg-nn-xs">
							<div class="product-img">
								<a href="selectproductview?id=${recomment.id }"><img src="img/product/${recomment.title }.jpg" alt="" /></a>
			...
			<div class="row">
				<div class="product-carousel">
					...
					<div class="col-md-12">
						<div class="product-wrapper mb-40 mrg-nn-xs">
							<div class="product-img">
								<a href="selectproductview?id=${recent.id }"><img src="img/product/${recent.title }.jpg" alt="" /></a>
								<span class="new-label">New</span>
